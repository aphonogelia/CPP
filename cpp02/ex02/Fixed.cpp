...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/05/01 16:31:22 by htharrau          #+#    #+#             */
/*   Updated: 2025/08/02 17:36:55 by htharrau         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	return (static_cast<float>(fixedPoint) / (1 << dec_bit));
}

int Fixed::toInt(void) const 
{
	return (fixedPoint >> dec_bit);
}
...
Fixed& Fixed::operator*=(const Fixed& other)
{
	...
	int64_t result = static_cast<int64_t>(this->fixedPoint) * static_cast<int64_t>(other.fixedPoint);
...
{
	stream << std::fixed << n.toFloat() << " (" << n.printBits() << ") ";
	return (stream);
}
