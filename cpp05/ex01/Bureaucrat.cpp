...
Bureaucrat::GradeTooHighException::GradeTooHighException() : errorMsg("Grade too high.") {}
...
Bureaucrat::GradeTooLowException::GradeTooLowException() : errorMsg("Grade too low.") {}
