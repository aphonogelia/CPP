...
/////////////////////
Form::Form() 
	: formName(defaultFName), isSigned(false), signGrade(defaultSEGrade), execGrade(defaultSEGrade) {
}
...
Form::Form(const Form& other) 
	: formName(other.formName), isSigned(other.isSigned), signGrade(other.signGrade), execGrade(other.execGrade) {
}
...
Form::~Form() {
	std::cout << "Form destructor called on " << formName << std::endl; 
}
