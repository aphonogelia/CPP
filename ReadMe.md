...
### [CPP01 — Memory & References](https://github.com/aphonogelia/cpp-modules/tree/main/cpp01)
* **Concepts**: Stack vs heap, `new`/`delete`, pointers vs references, file I/O.
* **Takeaway**: Memory management and avoiding leaks.

### [CPP02 — Orthodox Canonical Form](https://github.com/aphonogelia/cpp-modules/tree/main/cpp02)
...
### [CPP03 — Inheritance](https://github.com/aphonogelia/cpp-modules/tree/main/cpp03)
...
### [CPP04 — Polymorphism](https://github.com/aphonogelia/cpp-modules/tree/main/cpp04)
...
### [CPP05 — Exceptions](https://github.com/aphonogelia/cpp-modules/tree/main/cpp05)
* **Concepts**: `try`/`catch`/`throw`, custom exception classes, RAII.
* **Takeaway**: Robust error handling.

### [CPP06 — Casting](https://github.com/aphonogelia/cpp-modules/tree/main/cpp06)
* **Concepts**: `static_cast`, `dynamic_cast`, `reinterpret_cast`, `const_cast`.
* **Takeaway**: Explicit and safe type conversions.

### [CPP07 — Templates](https://github.com/aphonogelia/cpp-modules/tree/main/cpp07)
* **Concepts**: Function templates, class templates, generic programming.
* **Takeaway**: Reusable, type-independent code.

### [CPP08 — STL Containers & Algorithms](https://github.com/aphonogelia/cpp-modules/tree/main/cpp08)
...
## 🔗 Links
* **42 C++ Curriculum**: [https://42.fr/en/the-program/innovative-learning/](https://42.fr/en/the-program/innovative-learning/)
