...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/04/25 13:32:19 by htharrau          #+#    #+#             */
/*   Updated: 2025/05/11 14:56:35 by htharrau         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (this->hitPoints == 0) {
		std::cout << "ClapTrap " << this->name << " does not take damages as it does not have hit points." << std::endl;
	}
	else {
		...
		std::cout << "ClapTrap " << this->name << " gets " << amount 
			<< " points of damages and has now " << this->hitPoints << " hit points!" << std::endl;
	}
}
...
void ClapTrap::beRepaired(unsigned int amount)
{
	...
	if (this->hitPoints == 0 || this->energyPoints == 0) {
		...
		this->hitPoints += amount;
		std::cout << "ClapTrap " << this->name << " gets " << amount
		 << " points of reparations and has now " << hitPoints << " hit points!" << std::endl;
	}
}

void ClapTrap::accessValues() {
	std::cout << "ClapTrap " << this->name << " has " 
	<< this->hitPoints << " hit points and " 
