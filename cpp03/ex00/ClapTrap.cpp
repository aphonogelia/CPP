...
void ClapTrap::takeDamage(unsigned int amount) {
    if (this->hitPoints == 0) {
        std::cout << "ClapTrap " << this->name
                  << " does not take damages as it does not have hit points." << std::endl;
    } else {
        ...
        std::cout << "ClapTrap " << this->name << " gets " << amount
                  << " points of damages and has now " << this->hitPoints << " hit points!"
                  << std::endl;
    }
}
...
void ClapTrap::beRepaired(unsigned int amount) {
    if (this->hitPoints == 0 || this->energyPoints == 0) {
        ...
        this->hitPoints += amount;
        std::cout << "ClapTrap " << this->name << " gets " << amount
                  << " points of reparations and has now " << hitPoints << " hit points!"
                  << std::endl;
    }
}
