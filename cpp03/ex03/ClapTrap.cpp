...
{
	if (this->hitPoints == 0) {
		std::cout << "ClapTrap " << this->name << " does not take damage as it does not have hit points." << std::endl;
	}
	else {
		...
		std::cout << "ClapTrap " << this->name << " gets " << amount 
			<< " points of damage and has now " << this->hitPoints << " hit points." << std::endl;
	}
}
