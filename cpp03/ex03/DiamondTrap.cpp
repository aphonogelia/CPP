...
DiamondTrap& DiamondTrap::operator=(const DiamondTrap& other) {
	if (this != &other) { // alternativ to self-assignment checks: copy-and-swap idiom
		ClapTrap::operator=(other); //Call base class assignment operators to ensure all base parts are copied
		ScavTrap::operator=(other); //Call base class assignment operators to ensure all base parts are copied
		FragTrap::operator=(other); //Call base class assignment operators to ensure all base parts are copied
